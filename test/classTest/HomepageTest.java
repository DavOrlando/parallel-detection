...
public class HomepageTest {
	...
	public void noOutlinkTest() {
		try {
			...
			assertTrue(homepage.getMultilingualOutlinks().isEmpty());
		} catch (Exception e) {
			fail();
			e.printStackTrace();
		}
	...
	public void oneGoodOutlinkTest() {
		try {
			...
			assertEquals(1, homepage.getMultilingualOutlinks().size());
		} catch (Exception e) {
			e.printStackTrace();
			fail();
		}
	...
	public void twoGoodOutlink() {
		try {
			...
			assertEquals(2, homepage.getMultilingualOutlinks().size());
		} catch (Exception e) {
			e.printStackTrace();
			fail();
		}
